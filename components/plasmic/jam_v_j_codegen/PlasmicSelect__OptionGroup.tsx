...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: TfmwKZ42JmZQ/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: QGLFISqZbAKz/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__iWcHf)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__vx4Nk)}
              />
            </React.Fragment>
          ),
          value: args.children
